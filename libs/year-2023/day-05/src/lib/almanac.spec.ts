...
describe('followMaps', () => {
  it('should follow maps', () => {
    const maps = [
      parseAlmanacLines(['50 98 2', '52 50 48']),

      parseAlmanacLines(['0 15 37', '37 52 2', '39 0 15']),

      parseAlmanacLines(['49 53 8', '0 11 42', '42 0 7', '57 7 4']),

      parseAlmanacLines(['88 18 7', '18 25 70']),

      parseAlmanacLines(['45 77 23', '81 45 19', '68 64 13']),

      parseAlmanacLines(['0 69 1', '1 0 69']),

      parseAlmanacLines(['60 56 37', '56 93 4']),
    ];
